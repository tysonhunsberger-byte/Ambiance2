...
| **Python** | 3.10.x | Core services (`ambiance_qt_improved.py`, CLI, HTTP server) | Install Windows Installer(64bit) at https://www.python.org/downloads/release/python-31011/ Earlier 3.8 builds work, but 3.10 is the most stable with PyQtWebEngine. |
